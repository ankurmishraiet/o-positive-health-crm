...
export default function HospitalsCsvUploadPage() {
  ...
  const downloadTemplate = () => {
    const csvContent = "Name,Address,Phone,Email,City,Type\nCity General Hospital,123 Main Street,9876543210,info@citygeneral.com,Mumbai,Private\nCommunity Health Center,456 Oak Avenue,8765432109,contact@chc.com,Delhi,Government";
  ...
  const uploadFile = async () => {
    ...
    try {
      const response = await axios.post("/bulk-upload/hospitals", formData, {
        headers: {
  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto">
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h1 className="text-3xl font-bold">Upload Hospitals CSV</h1>
          <p className="text-gray-600">
            Bulk import hospitals from a CSV file
          </p>
        </div>
      </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-sm text-gray-600">
            Download the CSV template to see the required format for hospital imports.
          </p>
          <div className="bg-gray-50 p-4 rounded-lg mb-4">
            <p className="font-mono text-sm">
              <strong>Required columns:</strong> Name, Address, Phone, Email, City, Type
            </p>
          </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex justify-end space-x-3 mt-4">
              ...
              <Button onClick={() => router.push("/dashboard/hospitals")}>
                View Hospitals
              </Button>
            </div>
          </CardContent>
