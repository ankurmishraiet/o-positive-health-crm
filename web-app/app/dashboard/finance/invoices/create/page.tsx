...
function CreateInvoiceForm() {
  ...
  const entityType = searchParams.get("entityType") || "General";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Success",
        description: `${entityType} invoice created successfully`,
      });
  ...
  return (
    <div className="container mx-auto space-y-6 py-6">
      <div className="flex items-center space-x-3">
        ...
        <div>
          <h1 className="text-3xl font-bold">Create {entityType} Invoice</h1>
          <p className="text-gray-600">
            Create a new invoice for {entityType.toLowerCase()} services
          </p>
        </div>
      </div>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="entityName">{entityType} Name *</Label>
                <Input
                  id="entityName"
