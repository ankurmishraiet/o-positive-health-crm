...
export default function DoctorsCsvUploadPage() {
  ...
  const downloadTemplate = () => {
    const csvContent = "Name,Specialization,Email,Phone,City,Department,Type\nDr. John Smith,Cardiology,drsmith@hospital.com,9876543210,Mumbai,Cardiology,With Us\nDr. Jane Doe,Pediatrics,drjane@clinic.com,8765432109,Delhi,Pediatrics,Self Clinic";
  ...
  const uploadFile = async () => {
    ...
    try {
      const response = await axios.post("/bulk-upload/doctors", formData, {
        headers: {
  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto">
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h1 className="text-3xl font-bold">Upload Doctors CSV</h1>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-sm text-gray-600">
            Download the CSV template to see the required format for doctor imports.
          </p>
          <div className="bg-gray-50 p-4 rounded-lg mb-4">
            <p className="font-mono text-sm">
              <strong>Required columns:</strong> Name, Specialization, Email, Phone, City, Department, Type
            </p>
          </div>
